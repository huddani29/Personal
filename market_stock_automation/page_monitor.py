...
analyze_stock_sentiment = st.session_state["analyze_stock_sentiment"]
...
if data is not None and not data.empty:
    ...
    if not data_clean.empty:
        ...
        if "BUY" in current_signal: m4.success(f"AI JELZÉS: {current_signal}")
        elif "SELL" in current_signal: m4.error(f"AI JELZÉS: {current_signal}")
        else: m4.info(f"AI JELZÉS: {current_signal}")
